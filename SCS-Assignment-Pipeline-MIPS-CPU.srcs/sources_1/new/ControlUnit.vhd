...
begin
    ...
    instr := t_instr'val(computeInstructionIndex(opcode, func, 11));
    
    if_control <= (Bezr => '0', Bltzal => '0', Bgt => '0', Jal => '0', Jalr => '0', Jr => '0');
    id_control <= (ExtOp => '0');
    ex_control <= (RegDest => "00", AluSrc => '0', AluOp => op_X, ShiftVar => "00");
    ...
    case instr is
        ...
        when i_LWR => ex_control.RegDest <= "01"; wb_control.RegWrite <= '1'; wb_control.MemToReg <= "001";
        when i_SWR => mem_control.MemWrite <= '1'; 
        ...
        when i_MOV =>  wb_control.RegWrite <= '1'; ex_control.AluSrc <= '1';
        ...
        when i_ROL => ex_control.AluSrc <= '1'; wb_control.RegWrite <= '1';
        when i_ROR => ex_control.AluSrc <= '1'; wb_control.RegWrite <= '1';
        when i_LUI => ex_control.AluSrc <= '1'; id_control.ExtOp <= '1'; ex_control.ShiftVar <= "10"; wb_control.MemToReg <= "001"; wb_control.RegWrite <= '1'; 
        when i_LB => ex_control.AluSrc <= '1'; id_control.ExtOp <= '1'; mem_control.LB <= '1';  wb_control.MemToReg <= "001"; wb_control.RegWrite <= '1'; 
        when i_SB => ex_control.AluSrc <= '1'; mem_control.SB <= '1'; mem_control.MemWrite <= '1';
        when i_LWPI => ex_control.AluSrc <= '1'; id_control.ExtOp <= '1'; wb_control.MemToReg <= "100"; wb_control.RegWrite <= '1';
        ...
        when i_SWAPM => ex_control.AluSrc <= '1'; id_control.ExtOp <= '1'; mem_control.MemWrite <= '1'; wb_control.MemToReg <= "001"; wb_control.RegWrite <= '1';
        when i_ADDM => ex_control.AluSrc <= '1'; id_control.ExtOp <= '1'; wb_control.MemToReg <= "011"; wb_control.RegWrite <= '1';
        when i_JR => if_control.Jr <= '1';
        when i_JAL => wb_control.LinkRetAddr <= '1'; wb_control.RegWrite <= '1'; if_control.Jal <= '1';
        when i_JALR => wb_control.LinkRetAddr <= '1'; wb_control.RegWrite <= '1'; if_control.Jalr <= '1';
        when i_BEZR => if_control.Bezr <= '1';
        when i_BLTZAL => wb_control.LinkRetAddr <= '1'; wb_control.RegWrite <= '1'; if_control.Bltzal <= '1';
