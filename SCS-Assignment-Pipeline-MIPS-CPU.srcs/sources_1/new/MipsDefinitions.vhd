...
B"000000_00111_00011_01000_00000_000110", --Srlv	r[8] <- r[3] >> r[7]
B"000111_00000_00100_0000_0010_0000_0011", --Lui	r[4] <- x0203 & xFF000000	!!
...
B"001011_00101_00100_0000_0000_0000_0011", --Swpi	M[r[5] + 3] <- r[4], r[4] <- r[4] + 1	!!
B"001000_00101_00110_0000_0000_0001_1110", --Rol	r[6] <- r[5] rol 30
B"001001_01001_01000_0000_0000_0000_0010", --Ror	r[8] <- r[9] ror 2
B"001101_00101_01010_0000_0000_0000_0010", --Swapm  M[r[5] + 2] <-> r[10]	!!
B"001100_00101_00110_0000_0000_0000_1010", --Slti	if r[5] < 10 then r[6] <- 1 else r[6] <- 0	!!
...
B"000000_00000_00000_00000_00000_000000", --Nop	  	r[0] <- r[0] | r[0]
B"000000_00000_00000_00000_00000_000000", --Nop	  	r[0] <- r[0] | r[0]
B"000101_01111_00001_0000_0000_0000_0101", --Bgt	if r[15] > r[1] then PC <- PC + 5 else PC <- PC + 1
B"000000_00000_00000_00000_00000_000000", --Nop	  	r[0] <- r[0] | r[0]
B"000000_00000_00000_00000_00000_000000", --Nop	  	r[0] <- r[0] | r[0]
B"000000_00000_00000_00000_00000_000000", --Nop	  	r[0] <- r[0] | r[0]
B"000000_00000_00000_00000_00000_000000", --Nop	  	r[0] <- r[0] | r[0]
B"000110_00011_00000_0000_0000_0000_0100", --Bltzal if r[3] < 0 then r[31] <- PC + 1, PC <- PC + 4 else PC <- PC + 1
B"000000_00000_00000_00000_00000_000000", --Nop	  	r[0] <- r[0] | r[0]
B"000000_00000_00000_00000_00000_000000", --Nop	  	r[0] <- r[0] | r[0]
B"000000_00000_00000_00000_00000_000000", --Nop	  	r[0] <- r[0] | r[0]
